...
#
# Created by: Seokmin Kim (seokmin.kim@duke.edu)
...
print ("Record {0} indicates Sara was seen at {1}N and {2}W on {3}".format(recordID, obsLat,obsLat,obsDate))   #Inserting values to a list. {} corresponds to those within .format()
